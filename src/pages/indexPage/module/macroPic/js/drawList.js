...
export default {
  ...
  fillDrawData(optionType, option, optionData, comboxData, vm, callback) {
    ...
    if (optionData.length > 0) {
      ...
      //渲染序列series
      oldOption["series"] = this.afrashSeries(optionData, comboxData, vm);
      //y轴
  ...
  //渲染序列series
  afrashSeries(data, comboxData, vm) {
    var arr = [];
    var relationship = vm.currentDrawDataObj["relationship"];
    if (relationship) {

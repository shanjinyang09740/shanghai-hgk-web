  ...
  methods: {
    ...
    getMinAndMaxBgq() {
      ...
      if (this.defaultShowNum){
        this.currentMinBgq =
        bgqListArrNew.length > this.defaultShowNum ? this.maxBgq - this.defaultShowNum : this.minBgq;
      }else{
    ...
    bgqAreaSelectEvent() {
      ...
      if (this.defaultShowNum) {
        if (_THIS.total > this.defaultShowNum) {
          initSmallbarWidth = parseInt((10 / _THIS.total) * longbarDomWidth);
          initSmallbarLeft = parseInt(longbarDomWidth * (1 - 10 / _THIS.total));
      ...
      this.LRBtnsDom[0].onmousedown = function(e) {
        ...
        document.onmouseup = window.onblur = leftBtn.onlosecapture = function() {
      ...
      _THIS.LRBtnsDom[1].onmousedown = function(e) {
        ...
        document.onmouseup = window.onblur = rightBtn.onlosecapture = function() {
